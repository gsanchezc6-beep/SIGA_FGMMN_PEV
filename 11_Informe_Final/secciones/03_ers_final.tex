...
El ERS/SRS es un entregable independiente de este informe: reside completo en \texttt{01\_ERS/} del repositorio, en su versi\'on \textbf{4.0} del 22 de agosto de 2026, y se compila por separado. Esta secci\'on no lo reproduce. Presenta su estructura conforme a ISO/IEC/IEEE 29148:2018 (Tabla~\ref{tab:estructura-ers}), el cat\'alogo de requisitos clave, y lo que cambi\'o en la versi\'on 4.0 respecto de la 3.0 entregada en la Unidad III.
