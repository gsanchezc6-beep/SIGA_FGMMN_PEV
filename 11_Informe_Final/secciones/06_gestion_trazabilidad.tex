...
La l\'inea base de \emph{salida} s\'i queda etiquetada, que es la deuda que arrastraban las entregas previas: el commit de entrega de esta unidad lleva la etiqueta anotada \texttt{v4.0-PE5} en el repositorio. A partir de ella, cualquier verificaci\'on posterior —la re-inspecci\'on independiente que la \S5 declara pendiente, o la comparaci\'on con una versi\'on 5.0— tiene un punto fijo al que referirse, en lugar de depender de la fecha del \'ultimo commit de la rama.
