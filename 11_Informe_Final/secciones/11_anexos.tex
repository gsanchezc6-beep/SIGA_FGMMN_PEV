...
\textbf{Aporte en la Unidad V (PE5):} S\'anchez Cornejo Gary Alberto, Mu\~noz Qui\~nonez Yeranick Esther, Cede\~no Avila Winston Damian y Mendoza Palma Allan Jeremy son los integrantes activos del equipo en esta unidad. Gilces Carranza Jos\'e Ignacio no registra aporte verificable, ni en las entregas anteriores ni en la Unidad V. La Tabla~\ref{tab:aporte-pe5} recoge el reparto real sobre el repositorio de esta unidad, le\'ido del historial y no estimado.

\begin{table}[H]
\centering
\small
\begin{tabular}{|p{4.3cm}|c|c|p{5.7cm}|}
\hline
\textbf{Integrante} & \textbf{Commits} & \textbf{D\'ias activos} & \textbf{\'Areas del repositorio en que commite\'o} \\ \hline
S\'anchez Cornejo Gary Alberto & 18 & 4 & Estructura del repositorio, ERS, m\'etricas, informe final, trazabilidad, evidencias e integraci\'on general \\ \hline
Mu\~noz Qui\~nonez Yeranick Esther & 8 & 4 & Evidencias de campo, trazabilidad, secciones del informe final y materiales de defensa \\ \hline
Cede\~no Avila Winston Damian & 5 & 4 & Figuras del ERS, modelado UML y fichas de los componentes de IA \\ \hline
Mendoza Palma Allan Jeremy & 4 & 2 & Modelado UML y artefactos de trazabilidad \\ \hline
Gilces Carranza Jos\'e Ignacio & 0 & 0 & Sin aporte verificable en el historial \\ \hline
\end{tabular}
\caption{Aporte en la Unidad V (fuente: \texttt{git shortlog -sn} y \texttt{git log --name-only} sobre \repourl)}
\label{tab:aporte-pe5}
\end{table}

El reparto es desigual y se declara como tal en lugar de presentarlo equilibrado: el analista l\'ider concentra el 51\,\% de los commits (18 de 35). Toda la actividad se concentra adem\'as en seis d\'ias, del 18 al 23 de agosto de 2026, lo que refleja que el trabajo se ejecut\'o en bloque al final de la unidad y no de forma distribuida; es una debilidad de proceso, no de contenido, y as\'i se recoge en la retrospectiva (\S9). Las cifras se pueden reproducir sobre el repositorio con los dos comandos del pie de la tabla.
...
\textbf{Herramienta:} Claude (Anthropic), modelo Opus 5, v\'ia Claude Code, sesiones del 20 al 23 de agosto de 2026.
...
\item \textbf{Revisi\'on de cierre (23/08/2026):} inserci\'on y referencia de las diez figuras, ampliaci\'on de los res\'umenes, redibujado en TikZ del diagrama de estados de \texttt{Alerta} y completado de la Tabla~\ref{tab:aporte-pe5} de este anexo. En esa misma revisi\'on se detect\'o el defecto D-15 al confrontar el diagrama entregado con la \S4.6 del ERS; el hallazgo y su correcci\'on est\'an documentados en la \S5 y en \texttt{09\_Metricas/registro\_defectos.csv}. Las cifras de la Tabla~\ref{tab:aporte-pe5} se leyeron del historial de Git con los comandos que la propia tabla declara.
\end{itemize}
